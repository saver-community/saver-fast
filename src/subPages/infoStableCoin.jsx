...
export const InfoStableCoin = () => {
    ...
    const { busdDistributed, lastBusdDistributed } = useProvider();

    const allDistributed = {
        title: "Total BUSD Distribuido",
        amount: `${busdDistributed} BUSD`
    };

    const lastDistributed = {
        title: "Última Distribución de BUSD",
        amount: `${lastBusdDistributed} BUSD`
    };
