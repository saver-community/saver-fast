        ...
        <>
            ...
            <VStack w='full' display={{lg: "none", md: "none", sm: "flex", base: "flex"}}>
                ...
                <HStack w='full'>
                    <Spacer />
                    <Text align='justify' w='full'>
                        {'Los holders de SAVER no tienen que participar necesariamente en Saver Community y pueden realizar transacciones libremente con los tokens. Por el propio diseño del sistema en torno al SAVER, se espera que mantenga un incremento y sostenimiento de su precio alrededor de 1 BUSD, aunque puede que oscile entre 1 y 10 BUSD debido a los diferentes intereses y usos de sus usuarios. El potencial que vemos sobre todo para el token es que pueda estar bien distribuido en una comunidad que lo aprecie, favoreciendo así su uso y no tanto su especulación.'}
                    </Text>
                    <Spacer />
                </HStack>
