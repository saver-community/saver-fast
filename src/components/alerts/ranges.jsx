                    ...
                    <AlertDialogContent>
                        ...
                        <AlertDialogBody>
                            <VStack w='full' h='full'>
                                ...
                                <HStack w='full'>
                                    <Box w='15px' />
                                    <Text>- {props.donateBalance} BUSD en el Balance de Donaciones</Text>
                                    <Spacer />
                                </HStack>
                                <Box h='15px' />
                                <HStack w='full'>
                                ...
                                <HStack>
                                    <Box w='15px' />
                                    <Text>- Tener entre 10 y 100 BUSD en el Balance de donaciones</Text>
                                    <Spacer />
                                </HStack>
                                <HStack w='full'>
                                    <Text>Rango 2:</Text>
                                ...
                                <HStack w='full'>
                                    <Box w='15px' />
                                    <Text>- Tener entre 100 y 1000 BUSD en el Balance de donaciones</Text>
                                    <Spacer />
                                </HStack>
                                <HStack w='full'>
                                    <Text>Rango 3:</Text>
                                ...
                                <HStack w='full'>
                                    <Box w='15px' />
                                    <Text>- Tener entre 1000 y 10000 BUSD en el Balance de donaciones</Text>
                                    <Spacer />
                                </HStack>
                            </VStack>
                        </AlertDialogBody>
